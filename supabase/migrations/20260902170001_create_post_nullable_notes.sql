-- p_notes had no default, so the generated TypeScript types marked it as a
-- required non-null string instead of string | null, even though the
-- underlying posts.notes column is nullable. Giving it `default null`
-- fixes the generated type; supabase-js still always sends it explicitly.
